...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220614_cultivate_89a94247a39385749007_20220614131124_archive.zip';
	const ARCHIVE_SIZE		 = '62740162';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '89a9424-14131124';
    const SECONDARY_PACKAGE_HASH = 'a3919ad-14131124';
	const VERSION			 = '1.4.6';
